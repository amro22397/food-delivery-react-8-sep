...
const Header = () => {
  return (
    <div className='header flex flex-col items-start py-[120px] px-[90px]' id='header'>
        <h2 className='text-6xl tracking-wide' style={{fontFamily: 'Cambria'}}>Order your <br/> favourite food here</h2>
